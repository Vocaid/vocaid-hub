...
function getDemoDecision() {
  return {
    ...
    providers: [
      ...
      { address: "depin-1", agentId: "32", gpuModel: "GridPulse Energy · 200kW", teeType: "TEE", teeVerified: true, reputation: { starred: 79, uptime: 95, successRate: 87, responseTime: 0 }, validationScore: 70, compositeScore: 66, resourceType: "depin", resourceName: "GridPulse Energy", price: "$0.12/kWh" },
      { address: "depin-2", agentId: "33", gpuModel: "Tesla Model Y Fleet · LA", teeType: "TEE", teeVerified: true, reputation: { starred: 88, uptime: 92, successRate: 94, responseTime: 0 }, validationScore: 85, compositeScore: 78, resourceType: "depin", resourceName: "Tesla Model Y Fleet", price: "$0.45/mi" },
    ],
    selected: null,
    reasoning: {
      weights: { starred: 0.3, uptime: 0.25, successRate: 0.25, teeBonus: 0.2 },
