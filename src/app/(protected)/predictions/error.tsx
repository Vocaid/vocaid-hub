...
export default function PredictionsError(props: {
    ...
    <>
      <Page.Header className="p-0">
        <div className="h-12 flex items-center px-4">
          <span className="text-base font-semibold text-primary">Prediction Markets</span>
        </div>
      </Page.Header>
      <Page.Main className="flex flex-col items-center justify-center gap-4 px-4 py-16">
        ...
        <div className="text-center">
          <h2 className="text-base font-semibold text-primary">Failed to load predictions</h2>
          <p className="text-sm text-secondary mt-1">
            Could not fetch prediction markets from 0G Chain.
          </p>
        </div>
        <button
          onClick={reset}
